...
def list_artifacts(repo: str, run_id: str, attempt: str) -> list[dict]:
    # --paginate: the artifacts endpoint defaults to 30/page. The startswith
    # filter scopes to this run_attempt only, so a re-run doesn't retry a
    # suite that already passed on an earlier attempt.
